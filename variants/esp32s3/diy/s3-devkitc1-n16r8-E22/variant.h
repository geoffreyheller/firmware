...
#define SX126X_CS 10    // EBYTE module's NSS pin - esp32s3 VSPI defaults SPI_CS0 to gpio.10
#define SX126X_SCK 12   // EBYTE module's SCK pin - esp32s3 VSPI defaults SPI0_SCK to gpio.12
#define SX126X_MOSI 11  // EBYTE module's MOSI pin - esp32s3 VSPI defaults SPI0_MOSI to gpio.11
#define SX126X_MISO 13  // EBYTE module's MISO pin - esp32s3 VSPI defaults SPI0_MISO to gpio.13
